...
همه ما میدونیم که `nano` یک `text editor` ساده هست که میتونه کار ما رو بسیار راحت پس وقتی این فایل رو توسط nano میسازیم یک صفحه باز میشود که میتونیم مقادیر خودمون رو بنویسیم
